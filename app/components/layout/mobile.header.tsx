...
export default function MobileHeader() {
  ...
  return (
    <div className='flex flex-row w-full px-4  xl:hidden justify-between mt-5 sticky top-0 py-8  bg-primary'>
      <Button
      ...
      <AiOutlineMenuFold
        size={'2rem'}
        className='text-secondary hover:text-white cursor-pointer xl:hidden md:mr-11 mr-0'
