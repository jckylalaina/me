    ...
    <>
      ...
      <div className='leading-normal mt-8 flex flex-col gap-3'>
        <p>
          ...
          <Bold text='freelance' />
          gigs, my passion for crafting exceptional digital experiences knows no
          bounds.{' '}
        </p>
        <p>
          {' '}
          Driven by the desire to deliver excellence, I thrive on the challenge
          of creating solutions that exceed my clients‘ expectations. With a
          strong foundation in <Bold text='database architecture' /> and a keen
          eye for{' '}
          <Bold
            text='modern
            frontend'
